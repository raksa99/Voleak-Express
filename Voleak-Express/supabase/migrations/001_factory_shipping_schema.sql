...
-- (Exclusively Factory Shipping: Clean Drop & Rebuild)
-- =====================================================================
...
-- ---------------------------------------------------------------------
-- 0. CLEANUP LEGACY UNWANTED PASSENGER OBJECTS
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 3. TRUCKS (Freight Fleet: Heavy Container Trucks, Flatbeds, Cold-Chain Trucks)
-- ---------------------------------------------------------------------
...
create or replace view public.buses as
    select id, operator_id, plate_number, model, capacity_tons::int as capacity, status, truck_type, created_at
    from public.trucks;
