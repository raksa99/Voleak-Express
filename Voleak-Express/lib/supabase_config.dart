...
class SupabaseConfig {
  static String supabaseUrl = dotenv.env['supabaseUrl'] ?? dotenv.env['SUPABASE_URL'] ?? '';
  static String supabaseAnonKey = dotenv.env['supabaseAnonKey'] ?? dotenv.env['SUPABASE_ANON_KEY'] ?? '';
