...
class ManagerSchedulesScreen extends StatefulWidget {
  ...
  const ManagerSchedulesScreen({super.key, required this.operatorId});

  @override
  State<ManagerSchedulesScreen> createState() =>
      _ManagerSchedulesScreenState();
}

class _ManagerSchedulesScreenState extends State<ManagerSchedulesScreen> {
              ...
              child: _schedules.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        final truck = s['buses'] as Map<String, dynamic>?;
...
class _ScheduleFormSheetState extends State<_ScheduleFormSheet> {
  ...
  void initState() {
    ...
    if (widget.existing != null) {
      ...
      _selectedRouteId = (e['routes'] as Map?)?.containsKey('id') == true
          ...
          : null;
      _selectedTruckId = (e['buses'] as Map?)?.containsKey('id') == true
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          _trucks = List<Map<String, dynamic>>.from(results[1]);
          ...
          if (_selectedTruckId == null && _trucks.isNotEmpty) {
            _selectedTruckId = _trucks.first['id'] as String?;
          }
  ...
  Future<void> _save() async {
    ...
    if (_selectedTruckId == null) {
      _showSnack(context.tr.pleaseSelectTruck, isError: true);
      return;
    }
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Truck
                    _DropdownField(
                      label: context.tr.truckDropdown,
