...
class AdminOperatorsScreen extends StatefulWidget {
  ...
  @override
  State<AdminOperatorsScreen> createState() =>
...
class _AdminOperatorsScreenState extends State<AdminOperatorsScreen> {
  ...
  Future<void> _loadOperators() async {
    ...
    try {
      ...
      // Load truck/route counts per operator
...
class _ManagerCard extends StatelessWidget {
  ...
  const _ManagerCard({required this.operator, required this.onToggle});
