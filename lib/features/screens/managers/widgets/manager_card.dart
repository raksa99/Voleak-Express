...
class ManagerCard extends StatelessWidget {
  ...
  const ManagerCard({super.key, required this.operatorInfo});
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFF9E7E38), Color(0xFF9E7E38)],
        ),
...
class _ManagerLogo extends StatelessWidget {
  ...
  final String name;
  const _ManagerLogo({required this.logoUrl, required this.name});
