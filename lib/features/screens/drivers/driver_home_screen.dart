    ...
    try {
      ...
      if (user == null) {
        _profile = const UserModel(
          id: 'demo-driver-id',
          name: 'Seng Tri (Demo Driver)',
          email: 'driver@voleakexpress.com',
          role: 'driver',
          status: 'active',
        );
        _todayTrips = [
          TripModel(
            id: 'demo-trip-1',
            tripDate: DateTime.now().toLocal().toIso8601String().split('T')[0],
            status: 'scheduled',
            schedule: const ScheduleModel(
              id: 'demo-schedule-1',
              price: 15.00,
        ...
        _upcomingTrips = [
          TripModel(
            id: 'demo-trip-2',
            tripDate: DateTime.now().add(const Duration(days: 1)).toLocal().toIso8601String().split('T')[0],
            status: 'scheduled',
            schedule: const ScheduleModel(
              id: 'demo-schedule-2',
              price: 15.00,
        ...
        background: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Color(0xFFD4AF37), Color(0xFF9E7E38)],
            ),
          ),
          child: SafeArea(
            child: Padding(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 14),
          _StatsRow(driverId: _userRepo.client.auth.currentUser?.id ?? 'demo-driver-id'),
        ],
      ),
    );
  }
