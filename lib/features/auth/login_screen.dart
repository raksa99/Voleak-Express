    ...
    try {
      ...
      _googleAuthSub = AuthRepository().client.auth.onAuthStateChange.listen((
        ...
        if (existing == null) {
          ...
          if (!mounted) return;
          NavigationHelper.navigateByRole(context, 'driver');
          return;
        }
        ...
        final role = existing['role'] as String? ?? 'driver';
                ...
                return Container(
                  ...
                  child: IconButton(
                    icon: Row(
                      ...
                      children: [
                        const Icon(Icons.translate_rounded, color: Color(0xFFC5A85C), size: 18),
                        ...
                        children: [
                            ...
                            children: [
                              Expanded(
                                child: ElevatedButton.icon(
                                  onPressed: () => NavigationHelper.navigateByRole(context, 'driver'),
                              ...
                              Expanded(
                                child: ElevatedButton.icon(
                                  onPressed: () => NavigationHelper.navigateByRole(context, 'corporate'),
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: ElevatedButton.icon(
                                  onPressed: () => NavigationHelper.navigateByRole(context, 'manager'),
                              ...
                              Expanded(
                                child: ElevatedButton.icon(
                                  onPressed: () => NavigationHelper.navigateByRole(context, 'admin'),
