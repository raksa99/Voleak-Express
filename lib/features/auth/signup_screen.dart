                      ...
                      child: Center(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: const Color(0xFFC5A85C).withOpacity(0.2),
                                blurRadius: 15,
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: Checkbox(
                                      ...
                                      activeColor: const Color(0xFFC5A85C),
                                      shape: RoundedRectangleBorder(
    ...
    return Column(
      children: [
        Container(
          ...
          height: 32,
          decoration: BoxDecoration(
            color: isActive ? const Color(0xFFC5A85C) : const Color(0xFFE2E8F0),
            borderRadius: BorderRadius.circular(50),
          ),
          child: Center(
        ...
        Text(
          ...
          style: TextStyle(
            fontSize: 11,
            color: isActive ? const Color(0xFFC5A85C) : const Color(0xFF94A3B8),
